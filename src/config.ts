...
export const CONFIG = {
  ...
  game: {
    ...
    stroke: {
       ...
       * ここはその長さの上にブレード型のシルエットを描くための px 定数。
       * ローカル座標は「+X がボール側（フェース面）、+Y がトウ、-Y がヒール」。
       */
      putterShape: {
        /** フェース板の厚み [px]。ヘッド本体の前面にこの幅だけ明るい板を重ねる */
        faceThickness: 3,
        /** ヘッド本体の奥行き [px]。swipeTest.putterWidth より厚くしてブレードの胴に見せる */
        bodyDepth: 12,
        /** 本体の後ろに出すフランジの奥行き [px] */
        flangeDepth: 5,
        /** フランジをトウ側・ヒール側で短くする量 [px]。中央だけ残して重心の張り出しを出す */
        flangeInset: 10,
